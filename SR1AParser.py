...
#
# modified 16 Jan 2016 by Anthony Townsend <anthony@bitsandatoms.net>
# shifted all money fields +1 and reduced to length 8 to omit leading currency symbol cuasing integer data type errors
# e.g.
# python sr1a_csv.py Sales15.txt
# ValueError: invalid literal for int() with base 10: '$211350.0'
#
...
class SR1AParser:
    ...
    def __init__(self,record):
        ...
        self.tags = {"county_code": [0, 2, 1],
                ...
                "u_n_type": [33, 1, 0],
                "sr_nu_code": [34, 3, 0],
                "reported_sales_price": [38, 8, 1],
                "verified_sales_price": [47, 8, 1],
                "assessed_value_land": [56, 8, 1],
                "assessed_value_bldg": [65, 8, 1],
                "assessed_value_total": [74, 8, 1],
                "sales_ratio": [82, 5, 3, '3.2'],
                "realty_transfer_fee": [88, 8, 3, '7.2'],
                ...
                "addl_value_land1": [393, 8, 1],
                "addl_value_bldg1": [402, 8, 1],
                "addl_value_total1": [411, 8, 1],
                "addl_block2": [419, 9, 0],
                "addl_lot2": [428, 9, 0],
                "addl_qualifier2": [437, 5, 0],
                "addl_value_land2": [443, 8, 1],
                "addl_value_bldg2": [452, 8, 1],
                "addl_value_total2": [461, 8, 1],
                "addl_block3": [469, 9, 0],
                "addl_lot3": [478, 9, 0],
                "addl_qualifier3": [487, 5, 0],
                "addl_value_land3": [493, 8, 1],
                "addl_value_bldg3": [502, 8, 1],
                "addl_value_total3": [511, 8, 1],
                "addl_block4": [519, 9, 0],
                "addl_lot4": [528, 9, 0],
                "addl_qualifier4": [537, 5, 0],
                "addl_value_land4": [543, 8, 1],
                "addl_value_bldg4": [552, 8, 1],
                "addl_value_total4": [561, 8, 1],
                "addl_block5": [569, 9, 0],
                "addl_lot5": [578, 9, 0],
                "addl_qualifier5": [587, 5, 0],
                "addl_value_land5": [593, 8, 1],
                "addl_value_bldg5": [602, 8, 1],
                "addl_value_total5": [611, 8, 1],
